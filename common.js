...
var Render = {
  ...
  //---------------------------------------------------------------------------
  //---ATTENTION---that's player's section-------------------------------------
  //---here's the place to control player's sprite scale -> look at "scale/2.5"

  player: function(ctx, width, height, resolution, roadWidth, sprites, speedPercent, scale, destX, destY, steer, updown) {

    //--that's my own var "divider"
    //var scale = 0.3 * (1/160);
    var divider = 2; // if divider = 1, then car width = width of the roadlane 
    ...
    Render.sprite(ctx, width, height, resolution, roadWidth, sprites, sprite, scale/divider, destX, destY + bounce, -0.5, -1);
  },
...
var COLORS = {
  ...
  START:  { road: 'white',   grass: 'white',   rumble: 'red'                     },
...
var SPRITES = {
  ...
  CAR01:                  { x: 1006, y:  750, w:   72, h:   57 }, //capri
  PLAYER_UPHILL_LEFT:     { x:  512, y: 1399, w:  160, h:   88 },
  PLAYER_UPHILL_STRAIGHT: { x:  676, y: 1399, w:  160, h:   88 },
  PLAYER_UPHILL_RIGHT:    { x:  840, y: 1399, w:  160, h:   88 },
  PLAYER_LEFT:            { x: 1004, y: 1399, w:  160, h:   88 },
  PLAYER_STRAIGHT:        { x: 1168, y: 1399, w:  160, h:   88 },
  PLAYER_RIGHT:           { x: 1332, y: 1399, w:  160, h:   88 }
};

SPRITES.SCALE = 0.3 * (1/SPRITES.PLAYER_STRAIGHT.w) * 2 // for all game sprites, the reference sprite width should be 1/3rd the (half-)roadWidth
